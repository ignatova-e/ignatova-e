...
Я начинающий IT-специалист с опытом работы специалистом технической поддержки.
Развиваюсь на стыке разработки, инфраструктуры, тестирования и эксплуатации
систем.
...
Сейчас ищу стажировку или junior-позицию. Рассматриваю направления:
...
Мне интересны задачи, в которых нужно разбираться в устройстве систем,
исследовать причины сбоев, автоматизировать рутинные процессы и делать сервисы
стабильнее и удобнее для пользователей.

## Что я умею

- **Диагностика технических проблем.** Исследую баги, анализирую логи и
  интеграции, воспроизвожу ошибки и помогаю находить причины сбоев.
- **Тестирование.** Проверяю исправления и новые функции, описываю найденные
  проблемы и работаю с технической документацией.
...
- **Инструменты и инфраструктура.** Работаю с Git, знакома с Docker и GitHub
  Actions, участвовала в деплое командного проекта на GitHub Pages.
...
- Работаю специалистом технической поддержки в Flowwow.
...
- Продолжаю углублять знания Python, SQL, Linux, Docker, тестирования и
...
![Python](https://img.shields.io/badge/Python-facc15?style=flat-square&logo=python&logoColor=111827)
...
Открыта к стажировкам и junior-позициям в DevOps / SRE, Python backend, QA и
технической поддержке, а также к участию в open-source проектах.
